  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#0B0B0D' }}>
      <View className="flex-1 px-6 justify-center">
        ...
        <Text className="text-slate-400 mb-8">Connectez-vous pour accéder à votre dossier médical eHosp.</Text>
        ...
        <View className="flex-row justify-center">
          <Text className="text-slate-400">Nouveau sur eHosp ? </Text>
          <TouchableOpacity onPress={() => navigation.navigate('Register')}>
            <Text className="text-slate-950 font-semibold">Créer un compte</Text>
          </TouchableOpacity>
        </View>
      </View>
    </SafeAreaView>
